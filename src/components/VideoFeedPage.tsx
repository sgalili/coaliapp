...
export const VideoFeedPage = ({
  ...
  return <div className="relative min-h-screen">
      ...
      {onCreateContent && <button onClick={onCreateContent} className="fixed top-4 left-2 z-50 w-8 h-8 bg-muted/80 text-foreground rounded-full flex items-center justify-center shadow-sm hover:bg-muted transition-colors backdrop-blur-sm border border-border/20 mx-[13px]">
