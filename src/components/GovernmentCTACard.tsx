...
export const GovernmentCTACard = ({
  ...
  return <div className="px-4 pb-4">
      <div className="space-y-3 text-right">
        {/* Main CTA Button */}
        <button onClick={onClick} className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]">
