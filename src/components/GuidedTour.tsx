...
const tourSteps: TourStep[] = [
  {
    id: "decisions",
    title: "החלטות",
    description: "כאן תמצא את ההחלטות לקבלה בשכונה, בקהילות, בעיר ובמדינה. אם אתה לא רואה החלטות או מועמדים, הזמן את הארגונים והמוסדות לפרסם את ההחלטות שלהם כאן.",
