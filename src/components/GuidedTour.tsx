...
export const GuidedTour = ({ onClose }: GuidedTourProps) => {
  ...
  const positionTooltip = () => {
    ...
    // Use switch statement for ALL steps
    switch (step.position) {
      case 'bottom':
        ...
        break;
      case 'top':
        top = rect.top - 140; // Higher offset for navigation tabs to appear well above
