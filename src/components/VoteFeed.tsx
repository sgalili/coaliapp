...
export const VoteFeed = ({
  ...
  return <div className="relative h-screen overflow-hidden">
      ...
      <StoriesProgressBar totalStories={mockPollStories.length} currentStoryIndex={currentStoryIndex} />

      {/* Add Poll Button */}
      <Button size="icon" onClick={() => toast({
      title: "פתיחת יוצר הצבעות...",
      description: "בקרוב תוכלו ליצור הצבעות חדשות!"
    })} className="fixed top-5 left-4 z-50 w-10 h-10 rounded-full bg-black/30 text-white hover:bg-black/50 backdrop-blur-sm">
