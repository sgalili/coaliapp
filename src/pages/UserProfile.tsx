  ...
  return (
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <div className="p-6 space-y-4">
        ...
        {/* Stats - RTL Order: Watch, Trust, ZOOZ with softer unified text color */}
        <div className="flex justify-around py-4 border-y border-border">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="text-center cursor-pointer">
                  ...
                  <div className="text-2xl font-bold text-muted-foreground mt-1">{user.watchersCount}</div>
                </div>
              </TooltipTrigger>
              <TooltipContent>
                <p>מספר הצופים</p>
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="text-center cursor-pointer">
                  <TrustIcon />
                  <div className="text-2xl font-bold text-muted-foreground mt-1">{user.trustersCount}</div>
                </div>
              </TooltipTrigger>
              <TooltipContent>
          ...
          <ZoozEarnedDisplay zoozEarned={user.zoozEarned || 0} showAnimation textColorClass="text-muted-foreground" />
        </div>
