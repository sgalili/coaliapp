...
import { OrganizationVoteCard, OrganizationVote } from "../components/OrganizationVoteCard";
...
import { GovernmentCTACard } from "../components/GovernmentCTACard";
...
const VoteFeedPage = () => {
  ...
  // Always show onboarding on initial page load
  useEffect(() => {
    if (isInitialLoad) {
      ...
      <div className="h-screen overflow-y-scroll snap-y snap-mandatory">
        ...
        {content.city.map(section => (
          ...
          >
            <div className="h-full overflow-y-auto px-4 pb-24">
              {/* City votes */}
              {section.content.votes.map((item: any) => (
                <div key={item.id} className="w-full py-4">
              ...
              {/* City polls */}
              {section.content.polls.map((item: any) => (
                <div key={item.id} className="w-full py-4">
        ...
        {content.country.map(section => (
          ...
          >
            <div className="h-full overflow-y-auto px-4 pb-24">
              ...
              <div className="w-full py-6">
                <PositionCarousel
                  title="בחירות לראשות הממשלה 2026"
                  description="בחר את מועמדך לראשות הממשלה הבאה"
