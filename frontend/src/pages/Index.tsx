  ...
  return (
    <div className="h-screen bg-black overflow-hidden">
      ...
      <div className="fixed top-2 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2">
        ...
        {/* החלטות Button - Text style */}
        <button
          onClick={() => navigate('/decisions')}
          className="flex items-center gap-1 px-2 py-2 text-white font-semibold text-base transition-opacity hover:opacity-80"
        >
      ...
      <button
        onClick={toggleMute}
        className="fixed top-[88px] left-4 p-0 z-10"
      >
        {globalMute ? (
      ...
      {uniquePosts[currentPostIndex]?.user_id === 'demo-user' && (
        <div className="fixed top-[130px] left-4 z-30">
          <button
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
