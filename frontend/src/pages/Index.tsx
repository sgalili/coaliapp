...
import { Heart, Eye, MessageCircle, Share2, Volume2, VolumeX, CheckCircle, MapPin, Plus, X, Video, Upload, RefreshCw, Square, Loader2, Shield, ShieldCheck, Bookmark, MoreVertical, Play, Pause, Gift, Handshake, Crown } from "lucide-react";
...
const achvaPosts = [
  ...
  // Placeholders for 3 more videos - READY FOR YOUR URLS
  // Video 2: category: 'מחקר'
  // Video 3: category: 'אירועים'
  // Video 4: category: 'הרצאות'
];
