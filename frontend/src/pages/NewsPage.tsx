          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {unreadNotifications > 0 && (
                <span className="absolute -top-[1px] right-[9px] min-w-[16px] h-[16px] px-1 rounded-full bg-red-500 text-white text-[9px] font-bold flex items-center justify-center">
